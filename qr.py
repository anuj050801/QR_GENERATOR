...
# Creating the window
wn = Tk()
wn.title('Python QR Code Generator')
wn.geometry('700x700')
...
def generateCode():
    ...
    messagebox.showinfo("Python QR Code Generator",
                        "QR Code is saved successfully!")


# Label for the window
headingFrame = Frame(wn, bg="azure", bd=5)
headingFrame.place(relx=0.15, rely=0.05, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code with Python",
                     bg='azure', font=('Times', 20, 'bold'))
...
button = Button(wn, text='Generate Code', font=(
    'Courier', 15, 'normal'), command=generateCode)
